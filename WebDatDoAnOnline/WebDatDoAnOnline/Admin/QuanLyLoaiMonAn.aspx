<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="QuanLyLoaiMonAn.aspx.cs" Inherits="WebDatDoAnOnline.Admin.QuanLyLoaiMonAn" %>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-xl-4">
                                        <div class="stats-card">
                                            <h4 id="totalCategories" runat="server">0</h4>
                                            <p>Tổng loại món ăn</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xl-4">
                                        <div class="stats-card">
                                            <h4 id="activeCategories" runat="server">0</h4>
                                            <p>Loại đang hoạt động</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xl-4">
                                        <div class="stats-card">
                                            <h4 id="inactiveCategories" runat="server">0</h4>
                                            <p>Loại không hoạt động</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <!-- Form thêm/sửa loại món ăn (bên trái) -->
                                <div class="col-sm-12 col-md-4 col-lg-4 mobile-inputs">
                                    <asp:Panel ID="pManageCategory" runat="server">
                                        <h4 class="sub-title">Thêm/Sửa loại món ăn</h4>
                                        <div>
                                            <div class="form-group">
                                                <label>Tên loại món ăn</label>
                                                <div>
                                                    <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Vui lòng nhập tên loại món ăn"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                        ErrorMessage="Bắt buộc nhập tên loại món ăn" ForeColor="Red" Display="Dynamic"
                                            ...
                                            <div class="form-group">
                                                <label>Hình ảnh loại món ăn</label>
                                                <div>
                                ...
                                <!-- Danh sách loại món ăn (bên phải) -->
                                <div class="col-sm-12 col-md-8 col-lg-8">
                                    <h4 class="sub-title">Danh sách loại món ăn</h4>
                                    <!-- Thanh công cụ tìm kiếm và sắp xếp -->
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Tìm kiếm tên loại món ăn" AutoPostBack="true" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
                                        </div>
                                        <div class="col-md-6">
                                            <asp:DropDownList ID="ddlSort" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlSort_SelectedIndexChanged">
                                                ...
                                                <asp:ListItem Value="newest">Ngày thêm mới nhất</asp:ListItem>
                                                <asp:ListItem Value="name_asc">Tên: A đến Z</asp:ListItem>
                                                <asp:ListItem Value="name_desc">Tên: Z đến A</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                        ...
                                        <asp:Repeater ID="rCategory" runat="server" OnItemCommand="rCategory_ItemCommand" OnItemDataBound="rCategory_ItemDataBound">
                                            <HeaderTemplate>
                                                <table class="table data-table-export table-hover nowrap">
                                                    <thead>
                                                        <tr>
                                                            <th>STT</th>
                                                            <th class="table-plus">Tên loại món ăn</th>
                                                            <th>Hình ảnh</th>
                                                            <th>Có hoạt động?</th>
                                                            <th>Ngày tạo</th>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td class="table-plus"><%# Eval("TenLoaiMonAn") %></td>
                                                    <td>
                                                        <img alt="" width="40" src="<%# Utils.GetImageUrl(Eval("DiaChiAnhLoaiMonAn")) %>" class="img-thumbnail" />
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="lblIsActive" runat="server" Text='<%# Eval("CoHoatDongLoaiMonAn") %>'></asp:Label>
                                                    </td>
                                                    <td><%# Eval("NgayTaoLoaiMonAn") %></td>
                                                    <td>
                                                        <asp:LinkButton ID="lnkEdit" Text="Chỉnh sửa" runat="server" CssClass="badge badge-primary" CausesValidation="false" CommandArgument='<%# Eval("MaLoaiMonAn") %>' CommandName="edit">
                                                            <i class="ti-pencil"></i>
                                                        </asp:LinkButton>
                                                        <asp:LinkButton ID="lnkDelete" Text="Xóa" runat="server" CommandName="delete" CssClass="badge badge-danger" CommandArgument='<%# Eval("MaLoaiMonAn") %>' OnClientClick="return confirm('Bạn có thật sự muốn xóa loại món ăn này?');" CausesValidation="false">
                                                            <i class="ti-trash"></i>
                                                        </asp:LinkButton>
                                                    </td>
                                                </tr>
