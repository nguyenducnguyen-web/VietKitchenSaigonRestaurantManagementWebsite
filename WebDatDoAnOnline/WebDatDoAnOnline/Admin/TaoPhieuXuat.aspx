<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="TaoPhieuXuat.aspx.cs" Inherits="WebDatDoAnOnline.Admin.TaoPhieuXuat" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtUnitPrice" runat="server" CssClass="form-control" ReadOnly="true" placeholder="Đơn giá"></asp:TextBox>
                                    </div>
                                </div>

                                <!-- Right Panel: Export Order Details -->
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="table-responsive">
                                        <asp:Repeater ID="rExportDetails" runat="server" OnItemCommand="rExportDetails_ItemCommand">
                                            <HeaderTemplate>
                                                <table class="table data-table-export table-hover nowrap">
                                                    <thead>
                                                        <tr>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:LinkButton ID="lnkDelete" Text="Xóa" runat="server" CssClass="badge badge-danger" CommandArgument='<%# Eval("MaNguyenLieu") %>' CommandName="delete" OnClientClick="return confirm('Bạn có muốn xóa nguyên liệu này khỏi phiếu xuất?');">
                                                            <i class="ti-trash"></i>
                                                        </asp:LinkButton>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="text-center mt-4">
                                        <asp:Button ID="btnXuatHang" runat="server" Text="Xuất Hàng" CssClass="btn btn-primary" OnClick="btnXuatHang_Click" ValidationGroup="CreateExport" />
