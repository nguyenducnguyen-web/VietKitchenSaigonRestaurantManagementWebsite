<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="QuanLyMonAn.aspx.cs" Inherits="WebDatDoAnOnline.Admin.QuanLyMonAn" %>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-xl-4">
                                        <div class="stats-card">
                                            <h4 id="totalProducts" runat="server">0</h4>
                                            <p>Tổng món ăn</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xl-4">
                                        <div class="stats-card">
                                            <h4 id="activeProducts" runat="server">0</h4>
                                            <p>Món đang hoạt động</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xl-4">
                                        <div class="stats-card">
                                            <h4 id="lowStockProducts" runat="server">0</h4>
                                            <p>Món sắp hết hàng</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <!-- Form thêm/sửa món ăn (bên trái) -->
                                <div class="col-sm-12 col-md-4 col-lg-4 mobile-inputs">
                                    <asp:Panel ID="pManageProduct" runat="server">
                                        <h4 class="sub-title">Thêm/Sửa món ăn</h4>
                                        <div>
                                            <div class="form-group">
                                                <label>Tên món ăn</label>
                                                <div>
                                                    <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Vui lòng nhập tên món ăn"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                        ErrorMessage="Bắt buộc nhập tên món ăn" ForeColor="Red" Display="Dynamic"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control" placeholder="Vui lòng nhập mô tả món ăn" TextMode="MultiLine"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                                        ErrorMessage="Bắt buộc nhập mô tả món ăn" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ControlToValidate="txtDescription"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label>Giá món ăn (VND)</label>
                                                <div>
                                                    <asp:TextBox ID="txtPrice" runat="server" CssClass="form-control" placeholder="Vui lòng nhập giá món ăn"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                                        ErrorMessage="Bắt buộc nhập giá món ăn" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ControlToValidate="txtPrice"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                                        ErrorMessage="Giá phải là một số hợp lệ!" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ControlToValidate="txtPrice" ValidationExpression="^([1-9]\d*|0)$"></asp:RegularExpressionValidator>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <asp:TextBox ID="txtKhuyenMai" runat="server" CssClass="form-control" placeholder="Vui lòng nhập phần trăm khuyến mãi (0-100)"></asp:TextBox>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
                                                        ErrorMessage="Khuyến mãi phải là số từ 0 đến 100!" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ControlToValidate="txtKhuyenMai" ValidationExpression="^(100|[0-9]?[0-9])$"></asp:RegularExpressionValidator>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <asp:TextBox ID="txtQuantity" runat="server" CssClass="form-control" placeholder="Vui lòng nhập số lượng"></asp:TextBox>
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                        ErrorMessage="Số lượng phải là một số không âm!" ForeColor="Red" Display="Dynamic"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <asp:DropDownList ID="ddlCategories" runat="server" CssClass="form-control" DataSourceID="SqlDataSource1" DataTextField="TenLoaiMonAn" DataValueField="MaLoaiMonAn" AppendDataBoundItems="true">
                                                        <asp:ListItem Value="0">Chọn loại món ăn</asp:ListItem>
                                                    </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
                                                        ErrorMessage="Bắt buộc chọn loại món ăn!" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ControlToValidate="ddlCategories" InitialValue="0"></asp:RequiredFieldValidator>
                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=.\SQLEXPRESS;Initial Catalog=WebsiteDatDoAnOnline;Integrated Security=True;MultipleActiveResultSets=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT MaLoaiMonAn, TenLoaiMonAn FROM LoaiMonAn WHERE CoHoatDongLoaiMonAn = 1"></asp:SqlDataSource>
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-12 col-md-8 col-lg-8">
                                    <h4 class="sub-title">Danh sách món ăn</h4>
                                    <!-- Thanh công cụ tìm kiếm và sắp xếp -->
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Tìm kiếm tên món ăn" AutoPostBack="true" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand" OnItemDataBound="rProduct_ItemDataBound">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td class="table-plus"><%# Eval("TenMonAn") %></td>
                                                    <td>
                                                        <img alt="" width="40" src="<%# Utils.GetImageUrl(Eval("DiaChiAnhMonAn")) %>" class="img-thumbnail" />
                                                    </td>
                                                    <td><%# String.Format("{0:N0}", Convert.ToDecimal(Eval("GiaMonAn"))) %></td>
                                                    <td><%# Eval("KhuyenMai") != DBNull.Value ? Eval("KhuyenMai") + "%" : "0%" %></td>
                                                    <td>
                                                        <asp:Label ID="lblQuantity" runat="server" Text='<%# Eval("SoLuong") %>'></asp:Label>
                                                    </td>
                                                    <td><%# Eval("CategoryName") %></td>
                                                    <td>
                                                        <asp:Label ID="lblIsActive" runat="server" Text='<%# Eval("CoHoatDongMonAn") %>'></asp:Label>
                                                    </td>
                                                    <td><%# Eval("MoTaMonAn") %></td>
                                                    <td><%# Eval("NgayTaoMonAn") %></td>
                                                    <td>
                                                        <asp:LinkButton ID="lnkEdit" Text="Chỉnh sửa" runat="server" CssClass="badge badge-primary" CausesValidation="false" CommandArgument='<%# Eval("MaMonAn") %>' CommandName="edit">
                                                            <i class="ti-pencil"></i>
                                                        </asp:LinkButton>
                                                        <asp:LinkButton ID="lnkDelete" Text="Xóa" runat="server" CommandName="delete" CssClass="badge badge-danger" CommandArgument='<%# Eval("MaMonAn") %>' OnClientClick="return confirm('Bạn có thật sự muốn xóa món ăn này?');" CausesValidation="false">
                                                            <i class="ti-trash"></i>
                                                        </asp:LinkButton>
                                                    </td>
                                                </tr>
