<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="QuanLyNhaCungCap.aspx.cs" Inherits="WebDatDoAnOnline.Admin.QuanLyNhaCungCap" %>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xl-6">
                                        <div class="stats-card">
                                            <h4 id="totalSuppliers" runat="server">0</h4>
                                            <p>Tổng nhà cung cấp</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xl-6">
                                        <div class="stats-card">
                                            <h4 id="activeSuppliers" runat="server">0</h4>
                                            <p>Nhà cung cấp hoạt động</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <!-- Form thêm/sửa nhà cung cấp (bên trái) -->
                                <div class="col-sm-12 col-md-4 col-lg-4 mobile-inputs">
                                    <asp:Panel ID="pManageSupplier" runat="server">
                                        <h4 class="sub-title">Thêm/Sửa nhà cung cấp</h4>
                                        <div>
                                            <div class="form-group">
                                                <label>Mã nhà cung cấp</label>
                                                <div>
                                                    <asp:TextBox ID="txtMaNhaCungCap" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <asp:TextBox ID="txtTenNhaCungCap" runat="server" CssClass="form-control" placeholder="Vui lòng nhập tên nhà cung cấp"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvTenNhaCungCap" runat="server"
                                                        ErrorMessage="Bắt buộc nhập tên nhà cung cấp" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ControlToValidate="txtTenNhaCungCap"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <asp:TextBox ID="txtSdt" runat="server" CssClass="form-control" placeholder="Vui lòng nhập số điện thoại"></asp:TextBox>
                                                    <asp:RegularExpressionValidator ID="revSdt" runat="server"
                                                        ErrorMessage="Số điện thoại không hợp lệ (10-11 số)!" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ControlToValidate="txtSdt" ValidationExpression="^\d{10,11}$"></asp:RegularExpressionValidator>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Địa chỉ</label>
                                                <div>
                                                    <asp:TextBox ID="txtDiaChi" runat="server" CssClass="form-control" placeholder="Vui lòng nhập địa chỉ"></asp:TextBox>
                                                </div>
                                            </div>
                                ...
                                <!-- Danh sách nhà cung cấp (bên phải) -->
                                <div class="col-sm-12 col-md-8 col-lg-8">
                                    <h4 class="sub-title">Danh sách nhà cung cấp</h4>
                                    <!-- Thanh công cụ tìm kiếm và sắp xếp -->
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Tìm kiếm tên hoặc số điện thoại" AutoPostBack="true" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
                                        </div>
                                        <div class="col-md-6">
                                            <asp:DropDownList ID="ddlSort" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlSort_SelectedIndexChanged">
                                                ...
                                                <asp:ListItem Value="name_asc">Tên nhà cung cấp: A-Z</asp:ListItem>
                                                <asp:ListItem Value="name_desc">Tên nhà cung cấp: Z-A</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>

                                    <div class="table-responsive">
                                        <asp:Repeater ID="rSupplier" runat="server" OnItemCommand="rSupplier_ItemCommand" OnItemDataBound="rSupplier_ItemDataBound">
                                            <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td class="table-plus"><%# Eval("MaNhaCungCap") %></td>
                                                    <td><%# Eval("TenNhaCungCap") %></td>
                                                    <td><%# Eval("Sdt") %></td>
                                                    <td><%# Eval("DiaChi") %></td>
                                                    <td>
                                                        <asp:LinkButton ID="lnkEdit" Text="Chỉnh sửa" runat="server" CssClass="badge badge-primary" CausesValidation="false" CommandArgument='<%# Eval("MaNhaCungCap") %>' CommandName="edit">
                                                            <i class="ti-pencil"></i>
                                                        </asp:LinkButton>
                                                        <asp:LinkButton ID="lnkDelete" Text="Xóa" runat="server" CommandName="delete" CssClass="badge badge-danger" CommandArgument='<%# Eval("MaNhaCungCap") %>' OnClientClick="return confirm('Bạn có thật sự muốn xóa nhà cung cấp này?');" CausesValidation="false">
                                                            <i class="ti-trash"></i>
                                                        </asp:LinkButton>
                                                    </td>
                                                </tr>
