<%@ Page Title="" Language="C#" MasterPageFile="~/NguoiDung/NguoiDung.Master" AutoEventWireup="true" CodeBehind="LienHe.aspx.cs" Inherits="WebDatDoAnOnline.NguoiDung.LienHe" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        /* SweetAlert2 Custom */
        .custom-swal-popup {
            background: linear-gradient(135deg, #ff6f61, #ff0000) !important; /* Nền cam đỏ */
        ...
        .custom-swal-text {
            color: #ffffff !important; /* Chữ nội dung trắng */
            font-size: 1.2rem !important;
        }
        .custom-swal-button {
            background: #ff0000 !important; /* Nút đỏ */
            color: #ffffff !important; /* Chữ trên nút trắng */
        ...
        .custom-swal-button:hover {
            background: #ff3333 !important; /* Đỏ sáng khi hover */
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="book_section layout_padding">
        <div class="container position-relative">
            ...
            <!-- Thêm GIF động -->
           <%-- <img src="https://media.giphy.com/media/3o6Zt6KHxJTbXCnSso/giphy.gif" class="floating-gif" style="top: 10%; left: 5%; width: 100px;" alt="Star GIF" />
            <img src="https://media.giphy.com/media/l0HlPuurz4wGw3SPS/giphy.gif" class="floating-gif" style="top: 60%; right: 5%; width: 120px;" alt="Firework GIF" />--%>
            <div class="heading_container text-center">
                <h2>Liên Hệ Nhà Hàng Việt Kitchen SG</h2>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        <div>
                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Tên của quý khách"></asp:TextBox>
                        ...
                        <div>
                            ...
                            <asp:RequiredFieldValidator ID="rfvSubject" runat="server" ErrorMessage="Bắt buộc nhập chủ đề" ControlToValidate="txtSubject" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </div>
                        <div>
                            <asp:TextBox ID="txtMessage" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="5" placeholder="Nhập thông tin liên hệ của quý khách tại đây"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvMessage" runat="server" ErrorMessage="Bắt buộc nhập thông tin liên hệ" ControlToValidate="txtMessage" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </div>
                        <div class="btn_box text-center">
                            <asp:Button ID="btnSubmit" runat="server" Text="Gửi Liên Hệ" CssClass="btn" OnClick="btnSubmit_Click" />
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="contact-info">
                        ...
                        <p><i class="fas fa-map-marker-alt"></i> 15 Tôn Đức Thắng, Bến Nghé, Quận 1, Hồ Chí Minh</p>
                        <p><i class="fas fa-phone-alt"></i> +84 9765434529</p>
                        <p><i class="fas fa-envelope"></i> nhahangvietkitchensaigon@gmail.com</p>
                        <p><i class="fas fa-clock"></i> 08.00 AM -10.00 PM, Hàng ngày</p>
                    </div>
                    <div class="map_container mt-4">
